...
namespace AppMovilPrueba.Droid
{
    [Activity(Label = "AppMovilPrueba", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
